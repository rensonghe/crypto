...
path_quote='/home/xianglake/data/dc_data_bar/xrpusdt/%s_%s_202304.csv' % (symbol, time_span)
quote_data = pd.read_csv(path_quote)

path_signal='/home/xianglake/songhe/crypto_backtest/xrpusdt/%s_%s_20230401_0430_10bar_vwap120s_ST1.0_20230811_filter_50_150000_99sec.csv' % (exchange, symbol)
...
pnl_result.to_csv('/home/xianglake/yiliang/log/xrp_pnl_withstop_202304.csv',
            index=True, sep=',')
...
trades_result.to_csv('/home/xianglake/yiliang/log/xrp_trades_withstop_202304.csv',
            index=True, sep=',')
