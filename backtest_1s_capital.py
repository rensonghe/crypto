...
end_date = '2023-05-01'
path_signal='/home/xianglake/songhe/crypto_backtest/%s/%s_%s_20230401_0430_%sbar_%s_ST1.0_20231011_filter_%s_%s.csv' % (symbol,exchange, symbol,bar,p, out_threshold,amount)
...
plt.show()
pnl_result.to_csv('/home/xianglake/yiliang/log/%s_pnl_withstop_%s_%s_%s_%s_%s_%sp_%sl_sec_capital.csv'%(symbol, start_date, p,out_threshold,amount,slippage, pf_p,pf_l),
            index=True, sep=',')
...
trades_result.to_csv('/home/xianglake/yiliang/log/%s_trades_withstop_%s_%s_%s_%s_%s_%sp_%sl_sec_capital.csv'%(symbol, start_date, p,out_threshold,amount,slippage, pf_p,pf_l),
            index=True, sep=',')
#
