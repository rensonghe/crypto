...
threshold = 60000
side_long = 0.10040463675575177
side_short = 0.0975242492850093
out = 0.11245540366046966
...
if __name__ == '__main__':
    logger.add("./log/eosusdt_sub_{time}.log", rotation="1 day", enqueue=True, encoding='utf-8')
    main()
