...
def strategy(name, symbol, depth, trade, open_orders, balance, positions, tick1s):
    ...
    threshold = 110000
    side_long = 0.13311472707116143
    side_short = 0.06476963098518813
    out = 0.16135552881394954
...
if __name__ == '__main__':
    logger.add("./log/solusdt_{time}.log", rotation="1 day", enqueue=True, encoding='utf-8')
    main()
