...
def small_HCVOL(depth, trade, rolling):
...
def small_HCP(depth, trade, rolling):
...
def small_LCVOL(depth, trade, rolling):
...
def small_LCP(depth, trade, rolling):
...
def high_price_volume_ratio_80(depth, trade, rolling):
    ...
    return high_price_volume_ratio_80.fillna(0)

def low_price_volume_ratio_20(depth, trade, rolling):
    ...
    return low_price_volume_ratio_20.fillna(0)

def high_price_volume_ratio_90(depth, trade, rolling):
    ...
    return high_price_volume_ratio_90.fillna(0)

def low_price_volume_ratio_10(depth, trade, rolling):
    ...
    low_price_volume_ratio_10 = pd.Series(low_price_volume_10, index=trade.index).rolling(rolling).sum() / (
            v - v.shift(rolling))
    return low_price_volume_ratio_10.fillna(0)
...
def ht_trend_str_close(depth, trade, rolling=120):
    ...
    return ht_trend_str_close.fillna(0)


def ht_trend_str_avg(depth, trade, rolling=120):
    ...
    return ht_trend_str_avg.fillna(0)
...
def add_factor_process(depth, trade, min=40):
    ...
    df['active_buying'], df['t_active_buying'], df['norm_active_buying'], df[
        'confi_norm_active_buying'] = multi_active_buying(depth=depth, trade=trade, rolling=60*min)
    df['active_selling'], df['t_active_selling'], df['norm_active_selling'], df[
        'confi_norm_active_selling'] = multi_active_selling(depth=depth, trade=trade, rolling=60*min)
    df['HCVOL'] = HCVOL(depth=depth, trade=trade, rolling=60*min)
    df['HCP'] = HCP(depth=depth, trade=trade, rolling=60*min)
    df['LCVOL'] = LCVOL(depth=depth, trade=trade, rolling=60*min)
    df['LCP'] = LCP(depth=depth, trade=trade, rolling=60*min)
    df['small_HCVOL'] = small_HCVOL(depth=depth, trade=trade, rolling=60*min)
    df['small_HCP'] = small_HCP(depth=depth, trade=trade, rolling=60*min)
    df['small_LCVOL'] = small_LCVOL(depth=depth, trade=trade, rolling=60*min)
    df['small_LCP'] = small_LCP(depth=depth, trade=trade, rolling=60*min)
    df['high_price_volume_ratio_80'] = high_price_volume_ratio_80(depth=depth, trade=trade, rolling=60*min)
    df['low_price_volume_ratio_20'] = low_price_volume_ratio_20(depth=depth, trade=trade, rolling=60*min)
    df['high_price_volume_ratio_90'] = high_price_volume_ratio_90(depth=depth, trade=trade, rolling=60*min)
    df['low_price_volume_ratio_10'] = low_price_volume_ratio_10(depth=depth, trade=trade, rolling=60*min)
    df['ht_trend_str_close'] = ht_trend_str_close(depth=depth, trade=trade, rolling=60*min)
    df['ht_trend_str_avg'] = ht_trend_str_avg(depth=depth, trade=trade, rolling=60*min)
