...
threshold = 110000
side_long = 0.12047346154687995
side_short = 0.07907150881850189
out = 0.113660893813936
...
if __name__ == '__main__':
    logger.add("./log/xrpusdt_sub_{time}.log", rotation="1 day", enqueue=True, encoding='utf-8')
    main()
