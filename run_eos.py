...
def strategy(name, symbol, depth, trade, open_orders, balance, positions, tick1s):
    ...
    threshold = 60000
    side_long = 0.1052852042157609
    side_short = 0.09213881416894315
    out = 0.15371683780422968
...
if __name__ == '__main__':
    logger.add("./log/eosusdt_{time}.log", rotation="1 day", enqueue=True, encoding='utf-8')
    main()
